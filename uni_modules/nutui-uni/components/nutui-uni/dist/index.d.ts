...
import { PropType, ExtractPropTypes, CSSProperties, SetupContext, ComputedRef, VNode, RendererNode, RendererElement, VNodeChild, Ref } from 'vue';
...
declare const actionsheetProps: {
    ...
    position: {
        type: PropType<"center" | "top" | "bottom" | "left" | "right">;
        default: string;
    };
    transition: {
...
declare const stickyEmits: {
    change: (isFixed: boolean) => boolean;
};
type StickyEmits = typeof stickyEmits;
...
declare const calendarProps: {
    ...
    position: {
        type: vue.PropType<"center" | "top" | "bottom" | "left" | "right">;
        default: string;
    };
    transition: {
...
type InputType$1 = 'tel' | 'url' | 'date' | 'file' | 'text' | 'time' | 'week' | 'color' | 'digit' | 'email' | 'image' | 'month' | 'radio' | 'range' | 'reset' | 'button' | 'hidden' | 'number' | 'search' | 'submit' | 'checkbox' | 'password' | 'textarea' | 'datetime-local';
interface InputRule {
    pattern?: RegExp;
    message?: string;
    required?: boolean;
...
declare const inputEmits: {
    click: (evt: any) => any;
    clickInput: (evt: any) => any;
    blur: (evt: any) => any;
    focus: (evt: any) => any;
    clear: (val: string, evt: any) => any;
    keypress: () => boolean;
    confirm: (val: string, val2: any) => boolean;
    'update:modelValue': (val1?: string, val2?: any) => boolean;
};
...
declare const inputnumberEmits: {
    blur: (evt: any) => any;
    focus: (evt: any) => any;
    reduce: (evt: any | number) => boolean;
    add: (evt: any | number) => boolean;
    overlimit: (evt: any, type: 'reduce' | 'add') => boolean;
    change: (val1?: string | number, val2?: string | any | number) => boolean;
    'update:modelValue': (val1?: string, val2?: string | any) => boolean;
};
...
declare const uploaderProps: {
    ...
    mode: {
        type: PropType<"center" | "top" | "bottom" | "left" | "right" | "aspectFit" | "scaleToFill" | "aspectFill" | "widthFix" | "heightFix" | "top left" | "top right" | "bottom left" | "bottom right">;
        default: string;
    };
};
...
declare const addressEmits: {
    ...
    selected: (val: any, item: existRegionData, copyExistAdd: existRegionData[]) => boolean;
};
...
declare const addresslistEmits: {
    delIcon: (val: Event, item: unknown) => boolean;
    editIcon: (val: Event, item: unknown) => boolean;
    clickItem: (val: Event, item: unknown) => boolean;
    longCopy: (val: Event, item: unknown) => boolean;
    longSet: (val: Event, item: unknown) => boolean;
    longDel: (val: Event, item: unknown) => boolean;
    swipeDel: (val: Event, item: unknown) => boolean;
...
export { AVATAR_KEY, AcceptType, ActionSheetOption, ActionsheetEmits, ActionsheetProps, AddressEmits, AddressListEmits, AddressListProps, AddressProps, AnimateEmits, AnimateProps, AvatarGroupProps, AvatarProps, AvatarShape, AvatarSize, BacktopEmits, BacktopProps, BadgeProps, BarrageEmits, BarrageInst, BarrageProps, ButtonEmits, ButtonFormType, ButtonProps, ButtonShape, ButtonSize, ButtonType, CalendarEmits, CalendarItemEmits, CalendarItemProps, CalendarProps, CardProps, CascaderEmits, CascaderItemEmits, CascaderItemProps, CascaderProps, CategoryEmits, CategoryPaneEmits, CategoryPaneProps, CategoryProps, CategoryType, CellEmits, CellGroupProps, CellProps, CheckBoxInst, CheckboxEmits, CheckboxGroupEmits, CheckboxGroupProps, CheckboxProps, ChildType, ChooseFile, ChooseFileOptions, CircleProgressProps, CircleProgressStrokeLinecap, CodeInputEmits, CodeInputProps, ColProps, CollapseEmits, CollapseItemProps, CollapseProps, CommentEmits, CommentProps, ConfigProviderProps, ConfirmTextType, CountDownPropsProps, CountUpEmits, CountUpInst, CountUpProps, CountdownEmits, CountdownInst, CustomRegionData, CustomType, DatePickerEmits, DatePickerProps, DialogEmits, DialogInst, DialogOptions, DialogProps, Direction, DividerProps, DollMachineEmits, DollMachineProps, DragProps, ECardEmits, ECardProps, ElevatorData, ElevatorEmits, ElevatorInst, ElevatorProps, EllipsisEmits, EllipsisProps, EllipsisedValue, EmptyImage, EmptyProps, ErrorMessage, FORM_KEY, FileItem, FileItemStatus, FileType, FixednavEmits, FixednavProps, FooterDirection, FormEmits, FormInst, FormItemProps, FormItemRule, FormItemRuleWithoutValidator, FormProps, FormRule, FormRules, GRID_KEY, GeneralCallbackResult, GiftBoxEmits, GiftBoxInst, GiftBoxProps, GridDirection, GridItemEmits, GridItemProps, GridProps, HitEggsEmits, HitEggsProps, IClassNameProps, IClassNames, IData, IconEmits, IconProps, ImagePreviewEmits, ImagePreviewProps, IndicatorAlign, IndicatorProps, InfiniteLoadingEmits, InfiniteLoadingProps, InputAlignType, InputEmits, InputFormatTrigger, InputMode, InputNumberEmits, InputNumberProps, InputProps, InputRule, InputTarget, InputTextAlign, InputType$1 as InputType, InvoiceEmits, InvoiceProps, ListEmits, ListProps, LoadingPageProps, MarqueeEmits, MarqueeProps, MediaType, MenuItemInst, MenuItemOption, MenuItemProps, MenuProps, MenuitemEmits, NavBarEmits, NavBarProps, NoticeBarEmits, NoticeBarProps, NotifyEmits, NotifyInst, NotifyOptions, NotifyProps, NotifyType, NumberKeyBoardEmits, NumberKeyBoardProps, NutAnimation, NutAnimationName, NutAnimations, NutAnimationtimingFunction, NutResolver, OnProgressUpdateResult, OverlayEmits, OverlayProps, PaginationEmits, PaginationProps, PickerColumnEmits, PickerColumnOption, PickerColumnProps, PickerEmits, PickerOption, PickerProps, PopoverEmits, PopoverProps, PopupEmits, PopupProps, PricePosition, PriceProps, PriceSize, ProgressProps, ProgressSize, ProgressStatus, RadioGroupEmits, RadioGroupProps, RadioProps, RangeEmits, RangeProps, RateEmits, RateProps, RectItem, RegionData, RowProps, SIDEN_NAVBAR_KEY, SWIPER_KEY, SearchbarEmits, SearchbarProps, ShakeDiceEmits, ShakeDiceInst, ShakeDiceProps, ShortPasswordEmits, ShortPasswordProps, SideNavbaritemEmits, SideNavbaritemProps, SidenavbarProps, SignatureEmits, SignatureProps, SizeType, SkeletonProps, SkuEmits, SkuProps, SliderValue, SourceType, StepEmits, StepOptions, StepProps, StepsEmits, StepsProps, StickyEmits, StickyProps, SubSidenavbarEmits, SubSidenavbarProps, SwipeEmits, SwipeGroupProps, SwipeInts, SwipePosition, SwipeProps, SwiperEmits, SwiperInst, SwiperItemInst, SwiperProps, SwitchEmits, SwitchProps, TAB_KEY, TPrizeItem, TabBarEmits, TabBarItemProps, TabBarProps, TabPaneEmits, TabPaneProps, TableColumnProps, TableEmits, TableProps, TabsEmits, TabsProps, TabsSize, TagEmits, TagProps, TagType, TextAlign, TextareaEmits, TextareaProps, TimeDetailEmits, TimeDetailProps, TimePannelEmits, TimePannelProps, TimeSelectEmits, TimeSelectProps, Title, ToastEmits, ToastInst, ToastOptions, ToastProps, ToastType, TouchParams, TourEmits, TourProps, TransitionEmits, TransitionName, TransitionProps, TrendArrowProps, TurnTableEmits, TurnTableInst, TurnTableProps, UploadFileSuccessCallbackResult, UploadOptions, UploaderEmits, UploaderInst, UploaderProps, WaterMarkEmits, WaterMarkProps, actionsheetEmits, actionsheetProps, addressEmits, addressProps, addresslistEmits, addresslistProps, animateEmits, animateProps, avatarProps, avatargroupProps, backtopEmits, backtopProps, badgeProps, barrageEmits, barrageProps, calendarEmits, calendarProps, calendaritemEmits, calendaritemProps, cardProps, cascaderEmits, cascaderProps, cascaderitemEmits, cascaderitemProps, categoryEmits, categoryProps, categorypaneEmits, categorypaneProps, cellEmits, cellProps, cellgroupProps, checkboxEmits, checkboxProps, checkboxgroupEmits, checkboxgroupProps, chooseFile, circleprogressProps, clientHeight, codeinputEmits, codeinputProps, colProps, collapseEmits, collapseProps, collapseitemProps, commentEmits, commentProps, configProviderProps, confirmTextType, countupEmits, countupProps, createUploader, currentYear, datepickerEmits, datepickerProps, defaultAnimations, dialogEmits, dialogProps, dividerProps, dollmachineEmits, dollmachineProps, dragProps, ecardEmits, ecardProps, elevatorEmits, elevatorProps, ellipsisEmits, ellipsisProps, emptyProps, existRegionData, fixednavEmits, fixednavProps, formEmits, formProps, formitemProps, getClassNames, giftboxEmits, giftboxProps, gridItemEmits, gridItemProps, gridProps, hiteggsEmits, hiteggsProps, iconEmits, iconProps, imagepreviewEmits, imagepreviewProps, indicatorProps, infiniteloadingEmits, infiniteloadingProps, inputEmits, inputProps, inputnumberEmits, inputnumberProps, invoiceEmits, invoiceProps, isKeyOfAnimations, listEmits, listProps, loadingpageProps, marqueeEmits, marqueeProps, menuProps, menuitemEmits, menuitemProps, navbarEmits, navbarProps, noticebarEmits, noticebarProps, notifyEmits, notifyProps, numberkeyboardEmits, numberkeyboardProps, overlayEmits, overlayProps, paginationEmits, paginationProps, pickerEmits, pickerProps, pickercolumnEmits, pickercolumnProps, popoverEmits, popoverProps, popupEmits, popupProps, priceProps, progressProps, radioProps, radiogroupEmits, radiogroupProps, rangeEmits, rangeProps, rateEmits, rateProps, rowProps, searchbarEmits, searchbarProps, shakediceEmits, shakediceProps, shortpasswordEmits, shortpasswordProps, sidenavbarProps, sidenavbaritemEmits, sidenavbaritemProps, signatureEmits, signatureProps, skeletonProps, skuEmits, skuProps, stateProps, stepEmits, stepProps, stepsEmits, stepsProps, stickyEmits, stickyProps, subsidenavbarEmits, subsidenavbarProps, swipeEmits, swipeProps, swipegroupProps, swiperEmits, swiperProps, switchEmits, switchProps, tabbarEmits, tabbarProps, tabbaritemProps, tableEmits, tableProps, tabpaneEmits, tabpaneProps, tabsEmits, tabsProps, tagEmits, tagProps, textareaEmits, textareaProps, timedetailEmits, timedetailProps, timepannelEmits, timepannelProps, timeselectEmits, timeselectProps, toastEmits, toastProps, tourEmits, tourProps, transitionEmits, transitionProps, trendarrowProps, turntableEmits, turntableProps, uploaderEmits, uploaderProps, useDialog, useNotify, usePopup, useToast, useTransition, watermarkEmits, watermarkProps };
